      ...
      <div className="flex items-center justify-between px-3 md:px-4 py-3">
        ...
        <div className="flex gap-1 items-center flex-shrink-0">
          ...
          {(allApproved || ready) && (
            <button
              onClick={toggleReady}
              title={ready ? 'Quitar estado listo para IG' : 'Marcar como listo para Instagram'}
              className={`flex items-center gap-1.5 text-xs px-2.5 py-1.5 rounded-lg font-semibold transition-all ${ready ? 'bg-gradient-to-r from-purple-600 to-pink-500 text-white shadow-sm' : 'bg-slate-100 text-slate-500 hover:bg-gradient-to-r hover:from-purple-600 hover:to-pink-500 hover:text-white'}`}
            >
