...
export default function ClientRegionPage() {
  ...
  return (
    <div className="min-h-screen bg-[#1e2a36] flex flex-col">
      {/* Mockup de Instagram (solo lectura para el cliente) */}
                ...
                <div className="flex items-center justify-between gap-2 mb-4 md:mb-5">
                  ...
                  {images.length > 0 && (
                    <button
                      ...
                      className="flex items-center gap-1.5 bg-gradient-to-r from-purple-600 to-pink-500 text-white px-3 md:px-4 py-2.5 rounded-xl text-sm font-medium hover:opacity-90 transition-opacity flex-shrink-0"
                    >
                      ...
                      <span className="hidden sm:inline">Ver en Instagram</span>
                  ...
                  {images.map((img, idx) => (
                    ...
                    >
                      <div className="relative h-36 md:h-48 bg-slate-700">
                        ...
                        />
                        {img.on_instagram && (
                          <div className="absolute top-2 right-2 bg-gradient-to-tr from-purple-600 to-pink-500 rounded-full w-6 h-6 flex items-center justify-center shadow" title="Publicado en Instagram">
