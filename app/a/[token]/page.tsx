                  ...
                  >
                    <div className="relative h-36 md:h-48 bg-slate-700">
                      ...
                      <button
                        ...
                        title={img.published ? 'Quitar de Instagram' : 'Marcar como publicado en Instagram'}
                        className={`absolute top-2 right-2 rounded-full w-6 h-6 flex items-center justify-center shadow transition-all ${img.published ? 'bg-gradient-to-tr from-purple-600 to-pink-500 hover:opacity-70' : 'bg-slate-600/60 opacity-0 group-hover:opacity-100 hover:bg-gradient-to-tr hover:from-purple-600 hover:to-pink-500'}`}
                      >
